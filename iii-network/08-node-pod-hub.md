...
In The Nowland, we do not operate as isolated freelancers. We organize into an indestructible, three-tiered atomic structure: The Node, The Pod, and The Hub.
...
#### 2. The Pod (The Molecule / The Strike-Team)
...
The Pod is the ultimate unit of execution in the Symbiocracy. 
* **The Shared Engine:** When your Pod claims a massive `100c` bounty from the board, you execute it together. 
* **The 10% Failsafe:** As discussed, every transaction you complete automatically routes 10% into the Pod’s multi-sig treasury. This is your localized safety net. If a Node in your Pod suffers a burnout or a family emergency, the Pod's treasury covers their 4c baseline. The fiat state does not have to save them, because their friends already did. 
...
#### 3. The Hub (The Membrane / The Organism)
...
The Hub is the macro-structure. Legally, it is a registered Cooperative (like the German *eG*). Hundreds of Pods operate inside a single Hub. 
